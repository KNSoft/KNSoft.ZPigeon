...
public sealed partial class NativeServer
{
    ...
    public Task<PortableDevice[]> EnumeratePortableDevicesAsync() =>
        RunManagementAsync<PortableDevice[]>(context =>
            NativeMethods.EnumeratePortableDevices(ClientId, PortableDevicesCallback, context));
    ...
    public Task<PortableObjectPage> EnumeratePortableObjectsAsync(string deviceId, string? parentId, uint offset)
    {
        ...
        return RunManagementAsync<PortableObjectPage>(context =>
            NativeMethods.EnumeratePortableObjects(ClientId, deviceId,
    ...
    public Task CreatePortableFolderAsync(string deviceId, string parentId, string name) =>
        RunStatusAsync((callback, context) =>
            NativeMethods.CreatePortableFolder(ClientId, deviceId,
                                                (uint)deviceId.Length,
                                                parentId,
    ...
    public Task DeletePortableObjectAsync(string deviceId, string objectId) =>
        RunStatusAsync((callback, context) =>
            NativeMethods.DeletePortableObject(ClientId, deviceId,
                                                (uint)deviceId.Length,
                                                objectId,
    ...
    public Task RenamePortableObjectAsync(string deviceId, string objectId, string name) =>
        RunStatusAsync((callback, context) =>
            NativeMethods.RenamePortableObject(ClientId, deviceId,
                                                (uint)deviceId.Length,
                                                objectId,
                                                (uint)objectId.Length,
                                                name,
    ...
    private Task<FileTransfer> OpenPortableTransferAsync(
        string deviceId,
        string objectId,
        string? name,
        ulong fileSize,
        bool write)
    {
        ...
        var status = write ?
            NativeMethods.OpenPortableWrite(ClientId, deviceId,
                                            (uint)deviceId.Length,
                                            objectId,
                                            (uint)objectId.Length,
                                            name!,
                                            ...
                                            FileCloseCallback,
                                            context) :
            NativeMethods.OpenPortableRead(ClientId, deviceId,
                                           (uint)deviceId.Length,
                                           objectId,
                                           (uint)objectId.Length,
                                           FileOpenCallback,
...
internal static partial class NativeMethods
{
    ...
    internal static partial int EnumeratePortableDevices(
        ulong clientId,
        PortableDevicesCallback callback,
        nint context);
