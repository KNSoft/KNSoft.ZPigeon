...
#define ZP_SYSTEM_INFO_FIXED_SIZE 30
    ...
    _Out_ PULONG BytesWritten)
{
    ...
    *BytesWritten = RequiredSize;
    ...
    Status = ZpCodec_WriteUInt16(&Writer, (USHORT)Info->Architecture);
    ...
    _Out_ PZP_SYSTEM_INFO_VIEW View)
{
    ...
    Status = ZpCodec_ReadUInt16(&Reader, &Architecture);
    if (NT_SUCCESS(Status))
    {
    ...
    View->Architecture = (ZP_SYSTEM_ARCHITECTURE)Architecture;
    return STATUS_SUCCESS;
}
