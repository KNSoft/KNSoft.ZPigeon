...
#define ZP_PROCESS_OPERATION_OPEN_MEMORY_MAP 7
...
typedef struct _ZP_PROCESS_MEMORY_ALLOCATION
{
...
} ZP_PROCESS_MEMORY_ALLOCATION, *PZP_PROCESS_MEMORY_ALLOCATION;

typedef const ZP_PROCESS_MEMORY_ALLOCATION* PCZP_PROCESS_MEMORY_ALLOCATION;

typedef struct _ZP_PROCESS_MEMORY_ALLOCATION_VIEW
{
    ULONGLONG AllocationBase;
    ULONGLONG RegionSize;
    ULONGLONG CommitSize;
...
} ZP_PROCESS_MEMORY_ALLOCATION_VIEW, *PZP_PROCESS_MEMORY_ALLOCATION_VIEW;

typedef struct _ZP_PROCESS_MEMORY_ALLOCATION_MAP_VIEW
{
    const BYTE* Buffer;
    ULONG Length;
    ULONG SnapshotId;
    ULONG Count;
} ZP_PROCESS_MEMORY_ALLOCATION_MAP_VIEW, *PZP_PROCESS_MEMORY_ALLOCATION_MAP_VIEW;

typedef const ZP_PROCESS_MEMORY_ALLOCATION_MAP_VIEW* PCZP_PROCESS_MEMORY_ALLOCATION_MAP_VIEW;
...
typedef BYTE ZP_PROCESS_CONTROL;
...
#define ZP_PROCESS_FLAGS_MASK \
    (ZP_PROCESS_FLAG_SUSPENDED | ZP_PROCESS_FLAG_EFFICIENCY_MODE | \
     ZP_PROCESS_FLAG_VIRTUALIZATION_ALLOWED | ZP_PROCESS_FLAG_VIRTUALIZATION_ENABLED)
...
typedef struct _ZP_PROCESS_MODULE_RECORD
{
    ULONGLONG BaseAddress;
    ...
    PCWCH Path;
    ULONG PathLength;
} ZP_PROCESS_MODULE_RECORD, *PZP_PROCESS_MODULE_RECORD;

typedef const ZP_PROCESS_MODULE_RECORD* PCZP_PROCESS_MODULE_RECORD;

typedef struct _ZP_PROCESS_MODULE_RECORD_VIEW
{
    ULONGLONG BaseAddress;
    ULONGLONG EntryPoint;
    ULONGLONG LoadTime;
    ...
    ULONG LoadReason;
    ZP_STRING_VIEW Path;
} ZP_PROCESS_MODULE_RECORD_VIEW, *PZP_PROCESS_MODULE_RECORD_VIEW;

typedef struct _ZP_PROCESS_MODULE_LIST_VIEW
{
    const BYTE* Buffer;
    ULONG Length;
    ULONG Count;
    USHORT MachineType;
    BYTE MachineBits;
} ZP_PROCESS_MODULE_LIST_VIEW, *PZP_PROCESS_MODULE_LIST_VIEW;
