...
#define ZP_MAX_CLIENT_VERSION ZP_CLIENT_VERSION
...
#define ZP_CLIENT_HELLO_WIRE_SIZE (sizeof(USHORT) + ZP_CLIENT_PUBLIC_KEY_SIZE)
...
#define ZpServerRejectClientVersionTooNew ((ZP_SERVER_REJECT_REASON)2)
