...
#define ZP_RECORDING_MODULE_VERSION 1
...
typedef USHORT ZP_RECORDING_SOURCE, *PZP_RECORDING_SOURCE;
...
typedef USHORT ZP_RECORDING_CODEC, *PZP_RECORDING_CODEC;
...
typedef USHORT ZP_RECORDING_AUDIO_SOURCE, *PZP_RECORDING_AUDIO_SOURCE;
...
typedef USHORT ZP_RECORDING_STATE, *PZP_RECORDING_STATE;
