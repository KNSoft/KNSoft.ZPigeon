...
typedef BYTE ZP_WINDOW_CONTROL, *PZP_WINDOW_CONTROL;
...
#define ZP_WINDOW_FLAGS_MASK 0x000001FFUL
#define ZP_WINDOW_MONITOR_FLAG_PRIMARY 0x01
...
typedef BYTE ZP_WINDOW_INPUT_TYPE, *PZP_WINDOW_INPUT_TYPE;
...
#define ZpWindowInputFrameAck ((ZP_WINDOW_INPUT_TYPE)4)
#define ZpWindowInputOptions ((ZP_WINDOW_INPUT_TYPE)5)
#define ZpWindowInputVideoCodecs ((ZP_WINDOW_INPUT_TYPE)6)
...
#define ZP_WINDOW_FRAME_ACK_KEYFRAME 0x01
#define ZP_WINDOW_FRAME_ACK_FLAGS_MASK ZP_WINDOW_FRAME_ACK_KEYFRAME
...
#define ZP_WINDOW_CAPTURE_RECORD_WIRE_SIZE \
    (sizeof(BYTE) + 2 * sizeof(ULONG) + 6 * sizeof(USHORT))
...
#define ZP_WINDOW_CAPTURE_REQUEST_WIRE_SIZE \
    (sizeof(ULONGLONG) + 4 * sizeof(ULONG) + sizeof(USHORT) + 4 * sizeof(BYTE))

typedef BYTE ZP_WINDOW_CAPTURE_RECORD_TYPE, *PZP_WINDOW_CAPTURE_RECORD_TYPE;
...
#define ZpWindowCaptureRecordH264KeyFrame ((ZP_WINDOW_CAPTURE_RECORD_TYPE)3)
#define ZpWindowCaptureRecordH264Delta ((ZP_WINDOW_CAPTURE_RECORD_TYPE)4)
#define ZpWindowCaptureRecordH265KeyFrame ((ZP_WINDOW_CAPTURE_RECORD_TYPE)5)
#define ZpWindowCaptureRecordH265Delta ((ZP_WINDOW_CAPTURE_RECORD_TYPE)6)

typedef BYTE ZP_WINDOW_CAPTURE_MODE, *PZP_WINDOW_CAPTURE_MODE;

#define ZpWindowCaptureModeImage ((ZP_WINDOW_CAPTURE_MODE)0)
#define ZpWindowCaptureModeAuto ((ZP_WINDOW_CAPTURE_MODE)1)
#define ZpWindowCaptureModeVideo ((ZP_WINDOW_CAPTURE_MODE)2)

typedef BYTE ZP_WINDOW_VIDEO_CODEC, *PZP_WINDOW_VIDEO_CODEC;

#define ZpWindowVideoCodecH264 ((ZP_WINDOW_VIDEO_CODEC)0)
#define ZpWindowVideoCodecH265 ((ZP_WINDOW_VIDEO_CODEC)1)

#define ZP_WINDOW_VIDEO_CODECS_H264 0x01
#define ZP_WINDOW_VIDEO_CODECS_H265 0x02
#define ZP_WINDOW_VIDEO_CODECS_MASK (ZP_WINDOW_VIDEO_CODECS_H264 | ZP_WINDOW_VIDEO_CODECS_H265)

typedef struct _ZP_WINDOW_CAPTURE_ENCODING
{
    BYTE Mode : 2;
    BYTE Codec : 1;
    BYTE Reserved : 5;
} ZP_WINDOW_CAPTURE_ENCODING, *PZP_WINDOW_CAPTURE_ENCODING;

C_ASSERT(sizeof(ZP_WINDOW_CAPTURE_ENCODING) == sizeof(BYTE));
...
typedef struct _ZP_WINDOW_CAPTURE_OPTIONS
{
    ...
    ULONG MonitorIndex;
    ZP_WINDOW_CAPTURE_ENCODING Encoding;
