...
#define ZP_SYSTEM_MODULE_VERSION 1
#define ZP_SYSTEM_OPERATION_INFO 1

typedef enum _ZP_SYSTEM_ARCHITECTURE
{
    ZpSystemArchitectureX86 = 1,
    ZpSystemArchitectureX64 = 2,
    ZpSystemArchitectureArm64 = 3
} ZP_SYSTEM_ARCHITECTURE, *PZP_SYSTEM_ARCHITECTURE;
