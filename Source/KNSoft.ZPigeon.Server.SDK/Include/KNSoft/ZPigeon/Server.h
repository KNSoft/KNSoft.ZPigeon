...
typedef struct _ZP_IP_ADDRESS
{
    USHORT Family;
    BYTE Value[16];
} ZP_IP_ADDRESS, *PZP_IP_ADDRESS;
...
typedef BYTE ZP_SERVER_STATE, *PZP_SERVER_STATE;

#define ZpServerStateStopped ((ZP_SERVER_STATE)0)
#define ZpServerStateStarting ((ZP_SERVER_STATE)1)
#define ZpServerStateRunning ((ZP_SERVER_STATE)2)
#define ZpServerStateStopping ((ZP_SERVER_STATE)3)
