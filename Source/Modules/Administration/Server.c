    ...
    _Out_ ZP_REQUEST_HANDLE* Request)
{
    ...
    if (Callback == NULL ||
        (OperationId != ZP_ADMINISTRATION_OPERATION_ENUMERATE_USERS &&
         ...
         OperationId != ZP_ADMINISTRATION_OPERATION_ENUMERATE_APP_CONTAINERS))
    {
    ...
    _Out_ ZP_REQUEST_HANDLE* Request)
{
    ...
    if (Callback == NULL ||
        (OperationId != ZP_ADMINISTRATION_OPERATION_QUERY_CERTIFICATE &&
         ...
         OperationId != ZP_ADMINISTRATION_OPERATION_QUERY_OBJECT_DIRECTORY))
    {
        return STATUS_INVALID_PARAMETER;
    }
    ...
    _Out_ ZP_REQUEST_HANDLE* Request)
{
    ...
    if (Callback == NULL ||
        (OperationId != ZP_ADMINISTRATION_OPERATION_CONTROL_USER &&
         ...
         OperationId != ZP_ADMINISTRATION_OPERATION_CONTROL_APP_CONTAINER))
    {
        return STATUS_INVALID_PARAMETER;
    }
