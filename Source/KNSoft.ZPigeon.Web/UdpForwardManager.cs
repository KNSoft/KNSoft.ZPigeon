...
internal sealed class UdpForwardManager(NativeServer server) : IDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            using (datagram)
                await lease.Socket.SendToAsync(datagram.Memory,
                                               SocketFlags.None,
    ...
    private sealed class Lease : IDisposable
    {
        ...
        internal sealed class Association : IDisposable
        {
            private readonly Lock sync = new();
            ...
            internal Association(Lease lease, IPEndPoint key, IPEndPoint remoteEndpoint)
            {
                ...
                idleTimer = new(_ => Dispose(), null, lease.IdleTimeout, Timeout.InfiniteTimeSpan);
            }
