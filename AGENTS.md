...
- CRITICAL: Before the first release, keep compatibility versions at 1 and replace intermediate protocol, API, and
  data formats in place; do not preserve compatibility with development builds.
